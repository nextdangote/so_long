...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/23 18:10:04 by aguede            #+#    #+#             */
/*   Updated: 2023/09/23 18:57:33 by aguede           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incl/so_long.h"

void	ft_perform_right_move(t_game *game, int y, int x)
{
	game->map[y][x + 1] = 'P';
	game->map[y][x] = '0';
	game->move_count++;
...
int	ft_check_right_move(t_game *game, int y, int x)
{
...
void	ft_move_right(t_game *game)
{
	...
	while (y < n_lines)
	{
		...
		while (x < n_columns)
		{
			if (game->map[y][x] == 'P')
			{
				if (ft_check_right_move(game, y, x))
				{
					ft_perform_right_move(game, y, x);
					return ;
				}
			}
			x++;
